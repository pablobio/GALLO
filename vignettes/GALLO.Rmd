...
```{r, fig.width=9, fig.height=9, fig.cap="Chord plot showing the relationship between the studies (right-hand side) and the enriched QTLs (abbreviations in the left -hand side). Ref 1 is the correspondent ID for Feugang et al. (2010), while Ref 2 is the ID for Buzanskas et al. (2017)."}
...
#Adding a new column to provide an abbreviation for the references

out.qtls.filtered$Ref_ID<-ifelse(out.qtls.filtered$Reference== "Feugang et al. (2010)","Ref 1", "Ref 2")
