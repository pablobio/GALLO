...
```{r, fig.width=7, fig.height=7, fig.cap="Chord plot showing the relationship between the studies (right-hand side) and the enriched QTLs (abbreviations in the left -hand side). Ref 1 is the correspondent ID for Feugang et al. (2010), while Ref 2 is the ID for Buzanskas et al. (2017)."}
